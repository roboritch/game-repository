...
public class UnitSelectionScript : MonoBehaviour{
	...
	public void createThisUnit(int unitNumberFromSelection){
		if(Player.Instance.workingOnline){
			Player.Instance.thisPlayersNetworkHelper.Cmd_SendUnitSpawnEventToServer(unitInfo[unitNumberFromSelection].unitNameForLoad, currentGridblock.gridlocation.x, currentGridblock.gridlocation.y, 1 /*TODO this Player.Instance.team.index */);
			return;
		}
